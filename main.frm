...
Else
    If Left(Label2.Caption, 2) = "v2" Then
        ...
        Label2.Caption = "v2 tipi gösterge yazildi."
        Label2.BackColor = &H0&
        Label1.BackColor = &HFF00&
        MsgBox ("Yeni kilometre bilgisi v2 tip göstergeye basariyla yazildi...")
        ...
        Label1.Caption = "Islem basarili..."
        Label2.Caption = "v1 tipi gösterge yazildi."
        Label2.BackColor = &H0&
        Label1.BackColor = &HFF00&
        MsgBox ("Yeni kilometre bilgisi v1 tip göstergeye basariyla yazildi...")
...
CommonDialog1.DialogTitle = "Okunan dosyayi seçiniz"
